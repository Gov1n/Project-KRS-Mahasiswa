...
public class CourseForm extends javax.swing.JFrame {
    ...
    try {
        ...
        int status = (selectedCourseCode == null) ? 
                     controller.create(course) : 
                     controller.update(course, selectedCourseCode);
        ...
        if (status == 1) {
            ...
            JOptionPane.showMessageDialog(this, "Data Gagal! Cek kembali inputan Anda.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "SKS/Semester harus angka!");
    }
