...
private void setKRS() {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
       if (selecttedStudent == null || selecttedCourse == null) {
        JOptionPane.showMessageDialog(this, "Pilih mahasiswa dan mata kuliah!");
        return;
    }

    
    try {
        krs.setUas(Integer.parseInt(jTextFieldNilaiUAS.getText().trim()));
        krs.setUts(Integer.parseInt(jTextFieldNilaiUTS.getText().trim()));
        krs.setSikap(Integer.parseInt(jTextFieldNilaiSikap.getText().trim()));
        krs.setNim(selecttedStudent.getNim());
        krs.setNidn((selecttedLecturer != null) ? selecttedLecturer.getNidn() : "");
        krs.setSemester(Integer.parseInt(jComboBoxSM.getSelectedItem().toString()));
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Pastikan nilai berupa angka!");
        return;
    }
    ...
    if (status == 1) {
        Object[] rowData = {
            ...
            krs.getGrade(), 
            (selecttedLecturer != null) ? selecttedLecturer.toString() : "-"
        };
        ((DefaultTableModel) jTableNilai.getModel()).addRow(rowData);
        
        JOptionPane.showMessageDialog(this, "Berhasil disimpan! Grade: " + krs.getGrade());
    } else {
